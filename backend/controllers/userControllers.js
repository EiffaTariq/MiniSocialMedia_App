...
//   });
  ...
  const user = await User.findById(req.session.userId).select("-password").populate("posts");
  res.json(user);
});
...
//     .select("-password")
//     .populate("posts"); // optional: to include posts
...
export const followandUnfollowUser = TryCatch(async (req, res) => {
  ...
  console.log("User trying to follow:", req.user._id);
